!function () {
    ...
    function Z(n, t, e) {
        ...
        var o = "__on" + n, a = n.indexOf("."), c = V;
        a > 0 && (n = n.slice(0, a));
        var l = Ca.get(n);
        return l && (n = l, c = X), a ? t ? u : r : t ? y : i
    }
    ...
    function st(n, t, e) {
        return isNaN(n) && (n = 0), isNaN(t) && (t = 0), new ft(e, Math.cos(n *= Fa) * t, Math.sin(n) * t)
    }
    ...
    function ht(n, t, e) {
        ...
        return u = pt(u) * Ja, r = pt(r) * Ga, i = pt(i) * Ka, new mt(dt(3.2404542 * u - 1.5371385 * r - .4985314 * i), dt(-.969266 * u + 1.8760108 * r + .041556 * i), dt(.0556434 * u - .2040259 * r + 1.0572252 * i))
    }

    function gt(n, t, e) {
        return n > 0 ? new lt(Math.atan2(e, t) * Ha, Math.sqrt(t * t + e * e), n) : new lt(0 / 0, 0 / 0, n)
    }
    ...
    function yt(n) {
        return new mt(n >> 16, 255 & n >> 8, 255 & n)
    }
    ...
    function wt(n, t, e) {
        ...
        var r = vt((.4124564 * n + .3575761 * t + .1804375 * e) / Ja), u = vt((.2126729 * n + .7151522 * t + .072175 * e) / Ga), i = vt((.0193339 * n + .119192 * t + .9503041 * e) / Ka);
    ...
    function Ct(n, t, e, r) {
        ...
        return !oa.XDomainRequest || "withCredentials"in c || !/^(http(s)?:)?\/\//.test(n) || (c = new XDomainRequest), "onload"in c ? c.onload = c.onerror = u : c.onreadystatechange = function () {
            ...
            return c.abort(), i
        }, ta.rebind(i, o, "on"), null == r ? i : i.get(zt(r))
    }
    ...
    function Lt() {
        var n = Tt(), t = Rt() - n;
        t > 24 ? (isFinite(t) && (clearTimeout(ic), ic = setTimeout(Lt, t)), uc = 0) : (uc = 1, ac(Lt))
    }
    ...
    function Ut(n) {
        ...
        return function (n) {
            ...
            "$" === c && (v = u[0], d = u[1]), "r" != g || h || (g = "g"), null != h && ("g" == g ? h = Math.max(1, Math.min(21, h)) : ("e" == g || "f" == g) && (h = Math.max(0, Math.min(20, h)))), g = sc.get(g) || jt;
            var M = l && f;
            return function (n) {
                var e = d;
                if (m && n % 1)return "";
    ...
    function Ht(n, t, e) {
        ...
        var c = n.utc = Ot(n);
        return c.floor = c, c.round = Ot(r), c.ceil = Ot(u), c.offset = Ot(i), c.range = a, n
    }
    ...
    function Yt(n) {
        function t(n) {
            ...
            return t.parse = function (t) {
                ...
                var i = null != r.Z && hc !== Ft, o = new (i ? Ft : hc);
        ...
        }, t.multi = t.utc.multi = ce;
        var M = ta.map(), x = Zt(v), b = Vt(v), _ = Zt(d), w = Vt(d), S = Zt(m), k = Vt(m), E = Zt(y), A = Vt(y);
        ...
        var N = {
            a: function (n) {
                ...
                return It(1 + fc.dayOfYear(n), t, 3)
            }, L: function (n, t) {
                ...
                return It(fc.sundayOfYear(n), t, 2)
            }, w: function (n) {
                return n.getDay()
            }, W: function (n, t) {
                return It(fc.mondayOfYear(n), t, 2)
    ...
    function ke() {
        function n(n, u) {
            ...
            kc += l, Cc += l * (t + (t = o)), zc += l * (e + (e = a)), qc += l * (r + (r = c)), Se(t, e, r)
        }
        ...
        Dc.point = function (u, i) {
            u *= Fa;
            var o = Math.cos(i *= Fa);
            t = o * Math.cos(u), e = o * Math.sin(u), r = Math.sin(i), Dc.point = n, Se(t, e, r)
        }
    }
    ...
    function Ae() {
        function n(n, t) {
            n *= Fa;
            var e = Math.cos(t *= Fa), o = e * Math.cos(n), a = e * Math.sin(n), c = Math.sin(t), l = u * c - i * a, s = i * o - r * c, f = r * a - u * o, h = Math.sqrt(l * l + s * s + f * f), g = r * o + u * a + i * c, p = h && -nt(g) / h, v = Math.atan2(h, g);
            Lc += p * l, Tc += p * s, Rc += p * f, kc += v, Cc += v * (r + (r = o)), zc += v * (u + (u = a)), qc += v * (i + (i = c)), Se(r, u, i)
        }
        ...
        Dc.point = function (o, a) {
            ...
            var c = Math.cos(a *= Fa);
            r = c * Math.cos(o), u = c * Math.sin(o), i = Math.sin(a), Se(r, u, i)
        }, Dc.lineEnd = function () {
            n(t, e), Dc.lineEnd = Ee, Dc.point = we
        }
    }
    ...
    function ze(n, t, e, r, u) {
        ...
        if (n.forEach(function (n) {
                if (!((t = n.length - 1) <= 0)) {
                    ...
                    var c = new Le(e, n, null, !0), l = new Le(e, null, c, !1);
                    c.o = l, i.push(c), o.push(l), c = new Le(r, n, null, !1), l = new Le(r, null, c, !0), c.o = l, i.push(c), o.push(l)
                }
            }), o.sort(t), qe(i), qe(o), i.length) {
    ...
    function Ue(n) {
        ...
        return {
            lineStart: function () {
                ...
                va(c - Da) < Ta ? (n.point(e, r = (r + o) / 2 > 0 ? ja : -ja), n.point(u, r), n.lineEnd(), n.lineStart(), n.point(a, r), n.point(i, r), t = 0) : u !== a && c >= Da && (va(e - u) < Ta && (e -= u * Ta), va(i - a) < Ta && (i -= a * Ta), r = je(e, r, i, o), n.point(u, r), n.lineEnd(), n.lineStart(), n.point(a, r), t = 0), n.point(e = i, r = o), u = a
            }, lineEnd: function () {
                n.lineEnd(), e = r = 0 / 0
            }, clean: function () {
                return 2 - t
    ...
    function Oe(n) {
        ...
        function e(n) {
            ...
            return {
                lineStart: function () {
                    ...
                    if (!e && (l = c = v) && n.lineStart(), v !== c && (g = r(e, p), (_e(e, g) || _e(p, g)) && (p[0] += Ta, p[1] += Ta, v = t(p[0], p[1]))), v !== c)s = 0, v ? (n.lineStart(), g = r(p, e), n.point(g[0], g[1])) : (g = r(e, p), n.point(g[0], g[1]), n.lineEnd()), e = g; else if (a && e && o ^ v) {
                        var m;
        ...
        function r(n, t, e) {
            var r = ve(n), u = ve(t), o = [1, 0, 0], a = me(r, u), c = de(a, a), l = a[0], s = c - l * l;
            if (!s)return !e && n;
            var f = i * c / s, h = -i * l / s, g = me(o, a), p = Me(o, f), v = Me(a, h);
            ye(p, v);
        ...
        var i = Math.cos(n), o = i > 0, a = va(i) > Ta, c = pr(n, 6 * Fa);
        return Te(t, e, c, o ? [0, -n] : [-Da, n - Da])
    }
    ...
    function Ie(n, t, e, r) {
        ...
        return function (a) {
            ...
            var v, d, m, y, M, x, b, _, w, S, k, E = a, A = De(), N = Ye(n, t, e, r), C = {
                point: f,
                lineStart: h,
                lineEnd: g,
                polygonStart: function () {
                ...
                polygonEnd: function () {
                    ...
                    (e || u) && (a.polygonStart(), e && (a.lineStart(), l(null, null, 1, a), a.lineEnd()), u && ze(v, i, t, l, a), a.polygonEnd()), v = d = m = null
                }
            };
            return C
        }
    ...
    function Ge() {
        function n(n, r) {
            ...
            Cc += o * (t + n) / 2, zc += o * (e + r) / 2, qc += o, Je(t = n, e = r)
        }

        var t, e;
        Xc.point = function (r, u) {
            Xc.point = n, Je(t = r, e = u)
        }
    }
    ...
    function Qe() {
        function n(n, t) {
            ...
            Cc += o * (r + n) / 2, zc += o * (u + t) / 2, qc += o, o = u * n - r * t, Lc += o * (r + n), Tc += o * (u + t), Rc += 3 * o, Je(r = n, u = t)
        }

        var t, e, r, u;
        Xc.point = function (i, o) {
            Xc.point = n, Je(t = r = i, e = u = o)
        }, Xc.lineEnd = function () {
            n(t, e)
        }
    }
    ...
    function or(n) {
        ...
        var i, o, a, c, l, s, f = tr(function (n, t) {
            return n = i(n, t), [n[0] * h + c, l - n[1] * h]
        }), h = 150, g = 480, p = 250, v = 0, d = 0, m = 0, y = 0, M = 0, x = Pc, b = At, _ = null, w = null;
        return t.stream = function (n) {
            return s && (s.valid = !1), s = ar(x(o, f(b(n)))), s.valid = !0, s
        }, t.clipAngle = function (n) {
            return arguments.length ? (x = null == n ? (_ = n, Pc) : Oe((_ = +n) * Fa), u()) : _
        }, t.clipExtent = function (n) {
            return arguments.length ? (w = n, b = n ? Ie(n[0][0], n[0][1], n[1][0], n[1][1]) : At, u()) : w
        }, t.scale = function (n) {
    ...
    function sr(n, t, e) {
        return n ? t || e ? Ne(hr(n), gr(t, e)) : hr(n) : t || e ? gr(t, e) : lr
    }
    ...
    function pr(n, t) {
        ...
        return function (u, i, o, a) {
            var c = o * t;
            null != u ? (u = vr(e, u), i = vr(e, i), (o > 0 ? i > u : u > i) && (u += o * Pa)) : (u = n + o * Pa, i = n - .5 * c);
            for (var l, s = u; o > 0 ? s > i : i > s; s -= c)a.point((l = be([e, -r * Math.cos(s), -r * Math.sin(s)]))[0], l[1])
        }
    }
    ...
    function Sr(n, t) {
        ...
        return va(u) < Ta ? cr : (e.invert = function (n, t) {
            var e = i - t;
    ...
    function Ur(n) {
        $r(n), rl.remove(n), ol.push(n), eu(n)
    }

    function jr(n) {
        var t = n.circle, e = t.x, r = t.cy, u = {x: e, y: r}, i = n.P, o = n.N, a = [n];
        Ur(n);
        for (var c = i; c.circle && va(e - c.circle.x) < Ta && va(r - c.circle.cy) < Ta;)i = c.P, a.unshift(c), Ur(c), c = i;
        a.unshift(c), $r(c);
        for (var l = o; l.circle && va(e - l.circle.x) < Ta && va(r - l.circle.cy) < Ta;)o = l.N, a.push(l), Ur(l), l = o;
        a.push(l), $r(l);
        var s, f = a.length;
        for (s = 1; f > s; ++s)l = a[s], c = a[s - 1], Qr(l.edge, c.site, l.site, u);
        c = a[0], l = a[f - 1], l.edge = Gr(c.site, l.site, null, u), Xr(c), Xr(l)
    }

    function Fr(n) {
        for (var t, e, r, u, i = n.x, o = n.y, a = rl._; a;)if (r = Hr(a, o) - i, r > Ta)a = a.L; else {
            if (u = i - Or(a, o), !(u > Ta)) {
        ...
        if (rl.insert(t, c), t || e) {
            if (t === e)return $r(t), e = Pr(t.site), rl.insert(c, e), c.edge = e.edge = Gr(t.site, c.site), Xr(t), Xr(e), void 0;
            ...
            Qr(e.edge, l, p, x), c.edge = Gr(l, n, null, x), e.edge = Gr(n, p, null, x), Xr(t), Xr(e)
        }
    }
    ...
    function Ir(n) {
        for (var t, e, r, u, i, o, a, c, l, s, f = n[0][0], h = n[1][0], g = n[0][1], p = n[1][1], v = el, d = v.length; d--;)if (i = v[d], i && i.prepare())for (a = i.edges, c = a.length, o = 0; c > o;)s = a[o].end(), r = s.x, u = s.y, l = a[++o % c].start(), t = l.x, e = l.y, (va(r - t) > Ta || va(u - e) > Ta) && (a.splice(o, 0, new nu(Kr(i.site, s, va(r - f) < Ta && p - u > Ta ? {
            x: f,
            y: va(t - f) < Ta ? e : p
    ...
    function Xr(n) {
        ...
        if (t && e) {
            ...
            if (r !== i) {
                ...
                if (!(h >= -Ra)) {
                    var g = c * c + l * l, p = s * s + f * f, v = (f * g - l * p) / h, d = (c * p - s * g) / h, f = d + a, m = al.pop() || new Vr;
    ...
    function $r(n) {
        var t = n.circle;
        t && (t.P || (ul = t.N), il.remove(t), al.push(t), eu(t), n.circle = null)
    }

    function Br(n) {
        for (var t, e = tl, r = Ye(n[0][0], n[0][1], n[1][0], n[1][1]), u = e.length; u--;)t = e[u], (!Wr(t, n) || !r(t) || va(t.a.x - t.b.x) < Ta && va(t.a.y - t.b.y) < Ta) && (t.a = t.b = null, e.splice(u, 1))
    }
    ...
    function Gr(n, t, e, r) {
        var u = new Jr(n, t);
        return tl.push(u), e && Qr(u, n, t, e), r && Qr(u, t, n, r), el[n.i].edges.push(new nu(u, n, t)), el[t.i].edges.push(new nu(u, t, n)), u
    }
    ...
    function ou(n, t) {
        ...
        for (tl = [], el = new Array(n.length), rl = new tu, il = new tu; ;)if (u = ul, i && (!u || i.y < u.y || i.y === u.y && i.x < u.x))(i.x !== e || i.y !== r) && (el[i.i] = new Yr(i), Fr(i), e = i.x, r = i.y), i = n.pop(); else {
            if (!u)break;
            jr(u.arc)
        }
        t && (Br(t), Ir(t));
    ...
    function hu(n, t, e, r, u, i) {
        if (!n(t, e, r, u, i)) {
            ...
            c[0] && hu(n, c[0], e, r, o, a), c[1] && hu(n, c[1], o, r, u, a), c[2] && hu(n, c[2], e, a, o, i), c[3] && hu(n, c[3], o, a, u, i)
        }
    }
    ...
    function Uu(n) {
        var t = [n.a, n.b], e = [n.c, n.d], r = Fu(t), u = ju(t, e), i = Fu(Hu(e, t, -u)) || 0;
    ...
    function Zu(n) {
        for (var t = n.source, e = n.target, r = Xu(t, e), u = [t]; t !== r;)t = t.parent, u.push(t);
    ...
    function Xu(n, t) {
        if (n === t)return n;
        for (var e = Vu(n), r = Vu(t), u = e.pop(), i = r.pop(), o = null; u === i;)o = u, u = e.pop(), i = r.pop();
        return o
    }
    ...
    function Gu(n, t, e) {
        var r = 0, u = 0;
        if (n.charge = 0, !n.leaf)for (var i, o = n.nodes, a = o.length, c = -1; ++c < a;)i = o[c], null != i && (Gu(i, t, e), n.charge += i.charge, r += i.charge * i.cx, u += i.charge * i.cy);
        if (n.point) {
    ...
    function Ku(n, t) {
        return ta.rebind(n, t, "sort", "children", "value"), n.nodes = n, n.links = ui, n
    }
    ...
    function gi(n, t) {
        return pi(n, Math.ceil(Math.log(t.length) / Math.LN2 + 1))
    }
    ...
    function xi(n) {
        ...
        if ((e = n.children) && (l = e.length)) {
            ...
            if (e.forEach(bi), r = e[0], r.x = -r.r, r.y = 0, t(r), l > 1 && (u = e[1], u.x = u.r, u.y = 0, t(u), l > 2))for (i = e[2], Si(r, u, i), t(i), mi(r, i), r._pack_prev = i, mi(i, u), u = r._pack_next, o = 3; l > o; o++) {
                Si(r, u, i = e[o]);
                var p = 0, v = 1, d = 1;
                ...
                p ? (d > v || v == d && u.r < r.r ? yi(r, u = a) : yi(r = c, u), o--) : (mi(r, i), u = i, t(i))
            }
    ...
    function wi(n, t, e, r) {
        var u = n.children;
        if (n.x = t += r * n.x, n.y = e += r * n.y, n.r *= r, u)for (var i = -1, o = u.length; ++i < o;)wi(u[i], t, e, r)
    }
    ...
    function Ii(n, t, e, r) {
        function u() {
            var u = Math.min(n.length, t.length) > 2 ? Yi : Fi, c = r ? Iu : Yu;
            return o = u(n, t, c, e), a = u(t, n, c, yu), i
        }
    ...
    function Xi(n, t) {
        null == t && (t = 10);
        var e = Ui(n), r = e[1] - e[0], u = Math.pow(10, Math.floor(Math.log(r / t) / Math.LN10)), i = t / r * u;
    ...
    function Bi(n, t, e) {
        ...
        if (e) {
            ...
            if (u.shift(), "s" === u[8]) {
                ...
                return u[7] || (u[7] = "." + Wi(i.scale(r[2]))), u[8] = "f", e = ta.format(u.join("")), function (n) {
                    return e(i.scale(n)) + i.symbol
                }
            }
            u[7] || (u[7] = "." + Ji(u[8], r)), e = u.join("")
        } else e = ",." + Wi(r[2]) + "f";
        return ta.format(e)
    }
    ...
    function Ji(n, t) {
        var e = Wi(t[2]);
        return n in _l ? Math.abs(e - Wi(Math.max(va(t[0]), va(t[1])))) + +("e" !== n) : e - 2 * ("%" === n)
    }
    ...
    function Gi(n, t, e, r) {
        ...
        return o.invert = function (t) {
            ...
            var t = Hi(r.map(u), e ? Math : Sl);
            return n.domain(t), r = t.map(i), o
        }, o.ticks = function () {
            var n = Ui(r), o = [], a = n[0], c = n[1], l = Math.floor(u(a)), s = Math.ceil(u(c)), f = t % 1 ? 2 : t;
            if (isFinite(s - l)) {
                if (e) {
    ...
    function Ki(n, t, e) {
        ...
        return r.invert = function (t) {
            ...
            return arguments.length ? (u = Qi(t = o), i = Qi(1 / t), n.domain(e.map(u)), r) : t
        }, r.copy = function () {
    ...
    function go(n) {
        ...
        var e = Nr, r = Cr, u = Ce, i = po, o = i.key, a = .7;
        return t.x = function (n) {
            ...
            return arguments.length ? (o = "function" == typeof n ? i = n : (i = zl.get(n) || po).key, t) : o
    ...
    function bo(n, t) {
        return n.length < 3 ? po(n) : n[0] + wo((n.push(n[0]), n), So([n[n.length - 2]].concat(n, [n[1]]), t))
    }
    ...
    function wo(n, t) {
        if (t.length < 1 || n.length != t.length && n.length != t.length + 2)return po(n);
    ...
    function ko(n) {
        if (n.length < 3)return po(n);
        var t = 1, e = n.length, r = n[0], u = r[0], i = r[1], o = [u, u, u, (r = n[1])[0]], a = [i, i, i, r[1]], c = [u, ",", i, "L", Co(Tl, o), ",", Co(Tl, a)];
        for (n.push(n[e - 1]); ++t <= e;)r = n[t], o.shift(), o.push(r[0]), a.shift(), a.push(r[1]), zo(c, o, a);
        return n.pop(), c.push("L", r), c.join("")
    }

    function Eo(n) {
        if (n.length < 4)return po(n);
        for (var t, e = [], r = -1, u = n.length, i = [0], o = [0]; ++r < 3;)t = n[r], i.push(t[0]), o.push(t[1]);
        for (e.push(Co(Tl, i) + "," + Co(Tl, o)), --r; ++r < u;)t = n[r], i.shift(), i.push(t[0]), o.shift(), o.push(t[1]), zo(e, i, o);
        return e.join("")
    }

    function Ao(n) {
        for (var t, e, r = -1, u = n.length, i = u + 4, o = [], a = []; ++r < 4;)e = n[r % u], o.push(e[0]), a.push(e[1]);
        for (t = [Co(Tl, o), ",", Co(Tl, a)], --r; ++r < i;)e = n[r % u], o.shift(), o.push(e[0]), a.shift(), a.push(e[1]), zo(t, o, a);
        return t.join("")
    }
    ...
    function zo(n, t, e) {
        n.push("C", Co(ql, t), ",", Co(ql, e), ",", Co(Ll, t), ",", Co(Ll, e), ",", Co(Tl, t), ",", Co(Tl, e))
    }
    ...
    function Lo(n) {
        for (var t = 0, e = n.length - 1, r = [], u = n[0], i = n[1], o = r[0] = qo(u, i); ++t < e;)r[t] = (o + (o = qo(u = i, i = n[t + 1]))) / 2;
        return r[t] = o, r
    }

    function To(n) {
        for (var t, e, r, u, i = [], o = Lo(n), a = -1, c = n.length - 1; ++a < c;)t = qo(n[a], n[a + 1]), va(t) < Ta ? o[a] = o[a + 1] = 0 : (e = o[a] / t, r = o[a + 1] / t, u = e * e + r * r, u > 9 && (u = 3 * t / Math.sqrt(u), o[a] = u * e, o[a + 1] = u * r));
        for (a = -1; ++a <= c;)u = (n[Math.min(c, a + 1)][0] - n[Math.max(0, a - 1)][0]) / (6 * (1 + o[a] * o[a])), i.push([u || 0, o[a] * u || 0]);
        return i
    }

    function Ro(n) {
        return n.length < 3 ? po(n) : n[0] + wo(n, To(n))
    }
    ...
    function Po(n) {
        ...
        var e = Nr, r = Nr, u = 0, i = Cr, o = Ce, a = po, c = a.key, l = a, s = "L", f = .7;
        return t.x = function (n) {
            ...
            return arguments.length ? (c = "function" == typeof n ? a = n : (a = zl.get(n) || po).key, l = a.reverse || a, s = a.closed ? "M" : "L", t) : c
        }, t.tension = function (n) {
    ...
    function Io(n, t, e) {
        return xa(n, Fl), n.namespace = t, n.id = e, n
    }
    ...
    function $o(n, t, e, r, u) {
        ...
        if (!o) {
            ...
            o = i[r] = {
                ...
                function a(e) {
                    return i.active > r ? s(!1) : (i.active = r, o.event && o.event.start.call(n, g, t), o.tween.forEach(function (e, r) {
                        (r = r.call(n, g, t)) && d.push(r)
                    }), h = o.ease, f = o.duration, ta.timer(function () {
                        return v.c = l(e || 1) ? Ce : l, 1
                    }, 0, c), void 0)
                }

                function l(t) {
                    if (i.active !== r)return s(!1);
                    for (var e = t / f, u = h(e), o = d.length; o > 0;)d[--o].call(n, u);
                    return e >= 1 ? s(!0) : void 0
                }

                function s(u) {
                    return o.event && o.event[u ? "end" : "interrupt"].call(n, g, t), --i.count ? delete i[r] : delete n[e], 1
                }

                var f, h, g = n.__data__, p = o.delay, v = oc, d = [];
                return v.t = p + c, u >= p ? a(u - p) : (v.c = a, void 0)
            }, 0, c)
        }
    }
    ...
    function Go(n, t, e) {
        ...
        function u(n, e) {
            var r = n[1] - n[0], u = r / e, i = ta.bisect(Bl, u);
            return i == Bl.length ? [t.year, Xi(n.map(function (n) {
                return n / 31536e6
            }), e)[2]] : i ? t[u / Bl[i - 1] < Bl[i] / u ? i - 1 : i] : [Gl, Xi(n, e)[2]]
        }
        ...
        return r.invert = function (t) {
            ...
            var i = r.domain(), o = Ui(i), a = null == n ? u(o, 10) : "number" == typeof n && u(o, n);
            return a && (n = a[0], t = a[1]), r.domain(Hi(i, t > 1 ? {
                floor: function (t) {
    ...
    ta.touch = function (n, t, e) {
        if (arguments.length < 3 && (e = t, t = _().changedTouches), t)for (var r, u = 0, i = t.length; i > u; ++u)if ((r = t[u]).identifier === e)return B(n, r)
        ...
        function t(n, t, u, i, o) {
            return function () {
                ...
                var l, s = this, f = ta.event.target, h = s.parentNode, g = e.of(s, arguments), p = 0, v = n(), d = ".drag" + (null == v ? "" : "-" + v), m = ta.select(u()).on(i + d, a).on(o + d, c), y = $(), M = t(h, v);
                r ? (l = r.apply(s, arguments), l = [l.x - M[0], l.y - M[1]]) : l = [0, 0], g({type: "dragstart"})
            }
        }

        var e = w(n, "drag", "dragstart", "dragend"), r = null, u = t(y, ta.mouse, G, "mousemove", "mouseup"), i = t(W, ta.touch, J, "touchmove", "touchend");
    ...
    ta.interpolateZoom = function (n, t) {
        function e(n) {
            var t = n * y;
            if (m) {
                var e = rt(v), o = i / (Ya * h) * (e * ut(Oa * t + v) - et(v));
                return [r + o * l, u + o * s, i * e / rt(Oa * t + v)]
            }
        ...
        function s() {
            ...
            var r = this, i = ta.event.target, o = R.of(r, arguments), s = 0, f = ta.select(oa).on(q, n).on(L, e), h = t(ta.mouse(r)), g = $();
            I(r), a(o)
        }
        ...
        function f() {
            ...
            var g, p = this, v = R.of(p, arguments), d = {}, m = 0, M = ".zoom-" + ta.event.changedTouches[0].identifier, x = "touchmove" + M, _ = "touchend" + M, w = [], S = ta.select(p), E = $();
            e(), a(v), S.on(z, null).on(T, e)
        }

        function h() {
            var n = R.of(this, arguments);
            m ? clearTimeout(m) : (p = t(v = d || ta.mouse(this)), I(this), a(n)), m = setTimeout(function () {
                m = null, l(n)
        ...
        return n.event = function (n) {
            n.each(function () {
                ...
                Dl ? ta.select(this).transition().each("start.zoom", function () {
    ...
    var Ba = lt.prototype = new ot;
    Ba.brighter = function (n) {
        return new lt(this.h, this.c, Math.min(100, this.l + Wa * (arguments.length ? n : 1)))
    }, Ba.darker = function (n) {
        return new lt(this.h, this.c, Math.max(0, this.l - Wa * (arguments.length ? n : 1)))
    }, Ba.rgb = function () {
        return st(this.h, this.c, this.l).rgb()
    }, ta.lab = ft;
    var Wa = 18, Ja = .95047, Ga = 1, Ka = 1.08883, Qa = ft.prototype = new ot;
    Qa.brighter = function (n) {
        return new ft(Math.min(100, this.l + Wa * (arguments.length ? n : 1)), this.a, this.b)
    }, Qa.darker = function (n) {
        return new ft(Math.max(0, this.l - Wa * (arguments.length ? n : 1)), this.a, this.b)
    }, Qa.rgb = function () {
        return ht(this.l, this.a, this.b)
    }, ta.rgb = mt;
    var nc = mt.prototype = new ot;
    ...
    tc.forEach(function (n, t) {
        tc.set(n, yt(t))
    }), ta.functor = Et, ta.xhr = Nt(At), ta.dsv = function (n, t) {
        function e(n, e, i) {
    ...
    var cc = ["y", "z", "a", "f", "p", "n", "\xb5", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(Pt);
    ta.formatPrefix = function (n, t) {
        var e = 0;
        return n && (0 > n && (n *= -1), t && (n = ta.round(n, Dt(n, t))), e = 1 + Math.floor(1e-12 + Math.log(n) / Math.LN10), e = Math.max(-24, Math.min(24, 3 * Math.floor((e - 1) / 3)))), cc[8 + e / 3]
    };
    var lc = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i, sc = ta.map({
        b: function (n) {
            ...
            return (n = ta.round(n, Dt(n, t))).toFixed(Math.max(0, Math.min(20, Dt(n * (1 + 1e-15), t))))
        }
    }), fc = ta.time = {}, hc = Date;
    Ft.prototype = {
        getDate: function () {
    ...
    fc.year = Ht(function (n) {
        return n = fc.day(n), n.setMonth(0, 1), n
    }, function (n, t) {
        n.setFullYear(n.getFullYear() + t)
    }, function (n) {
        return n.getFullYear()
    }), fc.years = fc.year.range, fc.years.utc = fc.year.utc.range, fc.day = Ht(function (n) {
        var t = new hc(2e3, 0);
    ...
    ta.locale = function (n) {
        return {numberFormat: Ut(n), timeFormat: Yt(n)}
    };
    var mc = ta.locale({
        decimal: ".",
        thousands: ",",
    ...
    ta.format = mc.numberFormat, ta.geo = {}, le.prototype = {
        s: 0, t: 0, add: function (n) {
            se(n, this.t, yc), se(yc.s, this.s, this), this.s ? this.t += yc.t : this.s = yc.t
        }, reset: function () {
            this.s = this.t = 0
        }, valueOf: function () {
            return this.s
    ...
    ta.geo.stream = function (n, t) {
        n && Mc.hasOwnProperty(n.type) ? Mc[n.type](n, t) : fe(n, t)
    };
    var Mc = {
    ...
    ta.geo.bounds = function () {
        ...
        return Ra > u && (t = Cc, e = zc, r = qc, Ta > kc && (t = Ec, e = Ac, r = Nc), u = t * t + e * e + r * r, Ra > u) ? [0 / 0, 0 / 0] : [Math.atan2(e, t) * Ha, tt(r / Math.sqrt(u)) * Ha]
    };
    ...
    var jc, Fc, Hc, Oc, Yc, Ic, Zc = {
        point: y, lineStart: y, lineEnd: y, polygonStart: function () {
            Fc = 0, Zc.lineStart = Xe
        }, polygonEnd: function () {
            Zc.lineStart = Zc.lineEnd = Zc.point = y, jc += va(Fc / 2)
        }
    }, Vc = {point: $e, lineStart: y, lineEnd: y, polygonStart: y, polygonEnd: y}, Xc = {
        point: Je,
        lineStart: Ge,
        lineEnd: Ke,
        polygonStart: function () {
        ...
        polygonEnd: function () {
            Xc.point = Je, Xc.lineStart = Ge, Xc.lineEnd = Ke
        }
    };
    ta.geo.path = function () {
        ...
        return n.area = function (n) {
            ...
            return arguments.length ? (u = (e = n) ? n.stream || er(n) : At, t()) : e
    ...
    }, ta.geo.projection = ir, ta.geo.projectionMutator = or, (ta.geo.equirectangular = function () {
        return ir(cr)
    }).raw = cr.invert = cr, ta.geo.rotation = function (n) {
        function t(t) {
            return t = n(t[0] * Fa, t[1] * Fa), t[0] *= Ha, t[1] *= Ha, t
        }

        return n = sr(n[0] % 360 * Fa, n[1] * Fa, n.length > 2 ? n[2] * Fa : 0), t.invert = function (t) {
            return t = n.invert(t[0] * Fa, t[1] * Fa), t[0] *= Ha, t[1] *= Ha, t
        }, t
    }, lr.invert = cr, ta.geo.circle = function () {
        function n() {
            var n = "function" == typeof r ? r.apply(this, arguments) : r, t = sr(-n[0] * Fa, -n[1] * Fa, 0).invert, u = [];
        ...
        return n.origin = function (t) {
            ...
            return arguments.length ? (e = pr((t = +r) * Fa, u * Fa), n) : t
        }, n.precision = function (r) {
            return arguments.length ? (e = pr(t * Fa, (u = +r) * Fa), n) : u
        }, n.angle(90)
        ...
        return n.lines = function () {
            ...
            return arguments.length ? (y = +t, s = dr(a, o, 90), f = mr(r, e, y), h = dr(l, c, 90), g = mr(i, u, y), n) : y
        ...
        return xr(n[0] * Fa, n[1] * Fa, t[0] * Fa, t[1] * Fa)
    ...
    (ta.geo.azimuthalEquidistant = function () {
        ...
        return Ze(wr)
    }).raw = wr, (ta.geo.conicEquidistant = function () {
        return Ze(Sr)
    }).raw = Sr;
    var Gc = _r(function (n) {
        return 1 / n
    }, Math.atan);
    (ta.geo.gnomonic = function () {
        return ir(Gc)
    }).raw = Gc, kr.invert = function (n, t) {
    ...
    }).raw = Ar, ta.geom = {}, ta.geom.hull = function (n) {
        function t(n) {
            if (n.length < 3)return [];
            var t, u = Et(e), i = Et(r), o = n.length, a = [], c = [];
            for (t = 0; o > t; t++)a.push([+u.call(this, n[t], t), +i.call(this, n[t], t), t]);
            for (a.sort(qr), t = 0; o > t; t++)c.push([a[t][0], -a[t][1]]);
            var l = zr(a), s = zr(c), f = s[0] === l[0], h = s[s.length - 1] === l[l.length - 1], g = [];
    ...
    nl.area = function () {
        ...
        for (var t, e, r, u, i, o, a = Rr(n), c = -1, l = this.length - Rr(this), s = this[l - 1]; ++c < l;) {
    ...
    Yr.prototype.prepare = function () {
        ...
        return n ? t(n) : (t.links = function (n) {
            ...
            return ou(e(n)).cells.forEach(function (e, r) {
                for (var u, i, o = e.site, a = e.edges.sort(Zr), c = -1, l = a.length, s = a[l - 1].edge, f = s.l === o ? s.r : s.l; ++c < l;)u = s, i = f, s = a[c].edge, f = s.l === o ? s.r : s.l, r < i.i && r < f.i && cu(o, i, f) < 0 && t.push([n[r], n[i.i], n[f.i]])
            }), t
        }, t.x = function (n) {
    ...
    ta.geom.delaunay = function (n) {
        ...
        function i(n) {
            ...
            function l(n, t, e, r, u, o, a, c) {
                ...
                n.leaf = !1, n = n.nodes[g] || (n.nodes[g] = fu()), f ? u = l : a = l, h ? o = s : c = s, i(n, t, e, r, u, o, a, c)
            }
        ...
        var o, a = Nr, c = Cr;
        return (o = arguments.length) ? (a = lu, c = su, 3 === o && (u = e, r = t, e = t = 0), i(n)) : (i.x = function (n) {
    ...
    }, ta.interpolateRgb = pu, ta.interpolateObject = vu, ta.interpolateNumber = du, ta.interpolateString = mu;
    var ll = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, sl = new RegExp(ll.source, "g");
    ta.interpolate = yu, ta.interpolators = [function (n, t) {
        var e = typeof t;
        return ("string" === e ? tc.has(t) || /^(#|rgb\(|hsl\()/.test(t) ? pu : mu : t instanceof ot ? pu : Array.isArray(t) ? Mu : "object" === e && isNaN(t) ? vu : du)(n, t)
    }], ta.interpolateArray = Mu;
    var fl = function () {
        return At
    }, hl = ta.map({
        linear: fl, poly: Eu, quad: function () {
            return wu
        }, cubic: function () {
            return Su
        }, sin: function () {
            ...
            return Cu
        }, elastic: zu, back: qu, bounce: function () {
            return Lu
        }
    }), gl = ta.map({
        "in": At, out: bu, "in-out": _u, "out-in": function (n) {
            return _u(bu(n))
        }
    });
    ta.ease = function (n) {
        var t = n.indexOf("-"), e = t >= 0 ? n.slice(0, t) : n, r = t >= 0 ? n.slice(t + 1) : "in";
        return e = hl.get(e) || fl, r = gl.get(r) || At, xu(r(e.apply(null, ea.call(arguments, 1))))
    }, ta.interpolateHcl = Tu, ta.interpolateHsl = Ru, ta.interpolateLab = Du, ta.interpolateRound = Pu, ta.transform = function (n) {
        ...
        return (ta.transform = function (n) {
            ...
            return new Uu(e ? e.matrix : pl)
        })(n)
    }, Uu.prototype.toString = function () {
        return "translate(" + this.translate + ")rotate(" + this.rotate + ")skewX(" + this.skew + ")scale(" + this.scale + ")"
    };
    var pl = {a: 1, b: 0, c: 0, d: 1, e: 0, f: 0};
    ta.interpolateTransform = Ou, ta.layout = {}, ta.layout.bundle = function () {
        return function (n) {
            for (var t = [], e = -1, r = n.length; ++e < r;)t.push(Zu(n[e]));
            return t
        }
        ...
        return a.tick = function () {
            ...
            if (g)for (Gu(t = ta.geom.quadtree(m), r, o), e = -1; ++e < b;)(a = m[e]).fixed || t.visit(n(a));
            ...
            return e || (e = ta.behavior.drag().origin(At).on("dragstart.force", $u).on("drag.force", t).on("dragend.force", Bu)), arguments.length ? (this.on("mouseover.force", Wu).on("mouseout.force", Ju).call(e), void 0) : e
        }, ta.rebind(a, c, "on")
    };
    ...
    ta.layout.stack = function () {
        ...
        var t = At, e = ci, r = li, u = ai, i = ii, o = oi;
        return n.values = function (e) {
            return arguments.length ? (t = e, n) : t
        }, n.order = function (t) {
            return arguments.length ? (e = "function" == typeof t ? t : Ml.get(t) || ci, n) : e
        }, n.offset = function (t) {
            return arguments.length ? (r = "function" == typeof t ? t : xl.get(t) || li, n) : r
        }, n.x = function (t) {
            return arguments.length ? (i = t, n) : i
        }, n.y = function (t) {
    ...
    var Ml = ta.map({
        "inside-out": function (n) {
            var t, e, r = n.length, u = n.map(si), i = n.map(fi), o = ta.range(r).sort(function (n, t) {
                return u[n] - u[t]
            }), a = 0, c = 0, l = [], s = [];
    ...
    ta.layout.histogram = function () {
        ...
        var t, e = ta.layout.hierarchy().sort(di), r = 0, u = [1, 1];
        ...
        function n(n, u) {
            ...
            if (ni(h, e), h.parent.m = -h.z, Qu(h, r), l)Qu(f, i); else {
                var g = f, p = f, v = f;
                Qu(f, function (n) {
        ...
        function u(n, t, e) {
            if (t) {
                for (var r, u = n, i = n, o = t, c = u.parent.children[0], l = u.m, s = i.m, f = o.m, h = c.m; o = Ai(o), u = Ei(u), o && u;)c = Ei(c), i = Ai(i), i.a = n, r = o.z + f - u.z - l + a(o._, u._), r > 0 && (Ni(zi(o, n, e), n, r), l += r, s += r), f += o.m, l += u.m, h += c.m, s += i.m;
                o && !Ai(i) && (i.t = o, i.m += f - s), u && !Ei(c) && (c.t = u, c.m += l - h, e = n)
            }
            return e
        }
        ...
        var o = ta.layout.hierarchy().sort(null).value(null), a = ki, c = [1, 1], l = null;
        ...
        function n(n, i) {
            ...
            var s = Ti(c), f = Ri(c), h = s.x - e(s, f) / 2, g = f.x + e(f, s) / 2;
            return ni(c, u ? function (n) {
        ...
        var t = ta.layout.hierarchy().sort(null).value(null), e = ki, r = [1, 1], u = !1;
        return n.separation = function (t) {
            return arguments.length ? (e = t, n) : e
        }, n.size = function (t) {
        ...
        var o, a = ta.layout.hierarchy(), c = Math.round, l = [1, 1], s = null, f = Di, h = !1, g = "squarify", p = .5 * (1 + Math.sqrt(5));
        return i.size = function (n) {
            ...
            var r;
            return f = null == (s = n) ? Di : "function" == (r = typeof n) ? t : "number" === r ? (n = [n, n, n, n], e) : e, i
        }, i.round = function (n) {
    ...
    var bl = {floor: At, ceil: At};
    ta.scale.linear = function () {
        return Ii([0, 1], [0, 1], yu, !1)
    };
    var _l = {s: 1, g: 1, p: 1, r: 1, e: 1};
    ta.scale.log = function () {
        return Gi(ta.scale.linear().domain([0, 1]), 10, !0, [1, 10])
    };
    ...
    ta.scale.pow = function () {
        return Ki(ta.scale.linear(), 1, [0, 1])
    ...
    var kl = [2062260, 16744206, 2924588, 14034728, 9725885, 9197131, 14907330, 8355711, 12369186, 1556175].map(Mt), El = [2062260, 11454440, 16744206, 16759672, 2924588, 10018698, 14034728, 16750742, 9725885, 12955861, 9197131, 12885140, 14907330, 16234194, 8355711, 13092807, 12369186, 14408589, 1556175, 10410725].map(Mt), Al = [3750777, 5395619, 7040719, 10264286, 6519097, 9216594, 11915115, 13556636, 9202993, 12426809, 15186514, 15190932, 8666169, 11356490, 14049643, 15177372, 8077683, 10834324, 13528509, 14589654].map(Mt), Nl = [3244733, 7057110, 10406625, 13032431, 15095053, 16616764, 16625259, 16634018, 3253076, 7652470, 10607003, 13101504, 7695281, 10394312, 12369372, 14342891, 6513507, 9868950, 12434877, 14277081].map(Mt);
    ta.scale.quantile = function () {
        ...
        function n() {
            ...
            if ((m = (+c.apply(this, arguments) || 0) / 2) && (d = i === Cl ? Math.sqrt(n * n + l * l) : +i.apply(this, arguments), g || (A *= -1), l && (A = tt(d / l * Math.sin(m))), n && (E = tt(d / n * Math.sin(m)))), l) {
            ...
            if ((p = Math.min(Math.abs(l - n) / 2, +u.apply(this, arguments))) > .001) {
                v = l > n ^ g ? 0 : 1;
                var T = null == S ? [_, w] : null == x ? [y, M] : Tr([y, M], [S, k], [x, b], [_, w]), R = y - T[0], D = M - T[1], P = x - T[0], U = b - T[1], j = 1 / Math.sin(Math.acos((R * P + D * U) / (Math.sqrt(R * R + D * D) * Math.sqrt(P * P + U * U))) / 2), F = Math.sqrt(T[0] * T[0] + T[1] * T[1]);
                if (null != x) {
                    var H = Math.min(p, (l - F) / (j + 1)), O = ho(null == S ? [_, w] : [S, k], [y, M], l, H, g), Y = ho([x, b], [_, w], l, H, g);
                    p === H ? N.push("M", O[0], "A", H, ",", H, " 0 0,", v, " ", O[1], "A", l, ",", l, " 0 ", 1 - g ^ fo(O[1][0], O[1][1], Y[1][0], Y[1][1]), ",", g, " ", Y[1], "A", H, ",", H, " 0 0,", v, " ", Y[0]) : N.push("M", O[0], "A", H, ",", H, " 0 1,", v, " ", Y[0])
                } else N.push("M", y, ",", M);
                if (null != S) {
                    var I = Math.min(p, (n - F) / (j - 1)), Z = ho([y, M], [S, k], n, -I, g), V = ho([_, w], null == x ? [y, M] : [x, b], n, -I, g);
                    p === I ? N.push("L", V[0], "A", I, ",", I, " 0 0,", v, " ", V[1], "A", n, ",", n, " 0 ", g ^ fo(V[1][0], V[1][1], Z[1][0], Z[1][1]), ",", 1 - g, " ", Z[1], "A", I, ",", I, " 0 0,", v, " ", Z[0]) : N.push("L", V[0], "A", I, ",", I, " 0 0,", v, " ", Z[0])
                } else N.push("L", _, ",", w)
        ...
        var e = oo, r = ao, u = io, i = Cl, o = co, a = lo, c = so;
        return n.innerRadius = function (t) {
            ...
            return arguments.length ? (i = t == Cl ? Cl : Et(t), n) : i
        }, n.startAngle = function (t) {
    ...
    ta.svg.line.radial = function () {
    ...
    }, yo.reverse = Mo, Mo.reverse = yo, ta.svg.area = function () {
        return Po(At)
        ...
        var n = ta.svg.diagonal(), t = jo, e = n.projection;
        return n.projection = function (n) {
            return arguments.length ? e(Fo(t = n)) : t
        }, n
    }, ta.svg.symbol = function () {
        function n(n, r) {
            return (Rl.get(t.call(this, n, r)) || Yo)(e.call(this, n, r))
        }
    ...
    var Rl = ta.map({
        circle: Yo, cross: function (n) {
            var t = Math.sqrt(n / 5) / 2;
            return "M" + -3 * t + "," + -t + "H" + -t + "V" + -3 * t + "H" + t + "V" + -t + "H" + 3 * t + "V" + t + "H" + t + "V" + 3 * t + "H" + -t + "V" + t + "H" + -3 * t + "Z"
        }, diamond: function (n) {
            var t = Math.sqrt(n / (2 * jl)), e = t * jl;
            return "M0," + -t + "L" + e + ",0" + " 0," + t + " " + -e + ",0" + "Z"
        }, square: function (n) {
            var t = Math.sqrt(n) / 2;
            return "M" + -t + "," + -t + "L" + t + "," + -t + " " + t + "," + t + " " + -t + "," + t + "Z"
        }, "triangle-down": function (n) {
            var t = Math.sqrt(n / Ul), e = t * Ul / 2;
    ...
    var Dl, Pl, Ul = Math.sqrt(3), jl = Math.tan(30 * Fa), Fl = [], Hl = 0;
    Fl.call = ka.call, Fl.empty = ka.empty, Fl.node = ka.node, Fl.size = ka.size, ta.transition = function (n) {
        return arguments.length ? Dl ? n.transition() : n : Na.transition()
    }, ta.transition.prototype = Fl, Fl.select = function (n) {
        ...
        var o = "transform" == n ? Ou : yu, a = ta.ns.qualify(n);
        return Zo(this, "attr." + n, t, a.local ? i : u)
    }, Fl.attrTween = function (n, t) {
        function e(n, e) {
        ...
        function u(t) {
            return null == t ? r : (t += "", function () {
                ...
                return u !== t && (r = yu(u, t), function (t) {
    ...
    }, Fl.each = function (n, t) {
        var e = this.id, r = this.namespace;
        if (arguments.length < 2) {
            var u = Pl, i = Dl;
            Dl = e, H(this, function (t, u, i) {
                Pl = t[r][e], n.call(t, t.__data__, u, i)
            }), Pl = u, Dl = i
        ...
        function n(n) {
            n.each(function () {
                var n, l = ta.select(this), s = this.__chart__ || e, f = this.__chart__ = e.copy(), h = null == c ? f.ticks ? f.ticks.apply(f, a) : f.domain() : c, g = null == t ? f.tickFormat ? f.tickFormat.apply(f, a) : At : t, p = l.selectAll(".tick").data(h, f), v = p.enter().insert("g", ".domain").attr("class", "tick").style("opacity", Ta), d = ta.transition(p.exit()).style("opacity", Ta).remove(), m = ta.transition(p.order()).style("opacity", 1), y = Math.max(u, 0) + o, M = ji(f), x = l.selectAll(".domain").data([0]), b = (x.enter().append("path").attr("class", "domain"), ta.transition(x));
        ...
        var t, e = ta.scale.linear(), r = Ol, u = 6, i = 6, o = 3, a = [10], c = null;
        return n.scale = function (t) {
            return arguments.length ? (e = t, n) : e
        }, n.orient = function (t) {
            return arguments.length ? (r = t in Yl ? t + "" : Ol, n) : r
        }, n.ticks = function () {
    ...
    var Ol = "bottom", Yl = {top: 1, right: 1, bottom: 1, left: 1};
    ta.svg.brush = function () {
        function n(i) {
            i.each(function () {
                ...
                c && (s = ji(c), h.attr("x", s[0]).attr("width", s[1] - s[0]), e(f)), l && (s = ji(l), h.attr("y", s[0]).attr("height", s[1] - s[0]), r(f)), t(f)
            })
        }
        ...
        function u() {
            ...
            function d(n, t, e) {
                var r, u, a = ji(t), c = a[0], l = a[1], p = z[e], v = e ? f : s, d = v[1] - v[0];
            ...
            var y, M, x = this, _ = ta.select(ta.event.target), w = a.of(x, arguments), S = ta.select(x), k = _.datum(), E = !/^(n|s)$/.test(k) && c, A = !/^(e|w)$/.test(k) && l, N = _.classed("extent"), C = $(), z = ta.mouse(x), q = ta.select(oa).on("keydown.brush", u).on("keyup.brush", p);
        ...
        var i, o, a = w(n, "brushstart", "brush", "brushend"), c = null, l = null, s = [0, 0], f = [0, 0], h = !0, g = !0, p = Zl[0];
        return n.event = function (n) {
            n.each(function () {
                var n = a.of(this, arguments), t = {x: s, y: f, i: i, j: o}, e = this.__chart__ || t;
                this.__chart__ = t, Dl ? ta.select(this).transition().each("start.brush", function () {
            ...
            return arguments.length ? (c = t, p = Zl[!c << 1 | !l], n) : c
        }, n.y = function (t) {
            return arguments.length ? (l = t, p = Zl[!c << 1 | !l], n) : l
        }, n.clamp = function (t) {
    ...
    var Il = {
        ...
        se: "nwse-resize",
        sw: "nesw-resize"
    }, Zl = [["n", "e", "s", "w", "nw", "ne", "se", "sw"], ["e", "w"], ["n", "s"], []], Vl = fc.format = mc.timeFormat, Xl = Vl.utc, $l = Xl("%Y-%m-%dT%H:%M:%S.%LZ");
    Vl.iso = Date.prototype.toISOString && +new Date("2000-01-01T00:00:00.000Z") ? Jo : $l, Jo.parse = function (n) {
        var t = new Date(n);
        return isNaN(t) ? null : t
    }, Jo.toString = $l.toString, fc.second = Ht(function (n) {
        return new hc(1e3 * Math.floor(n / 1e3))
    }, function (n, t) {
        n.setTime(n.getTime() + 1e3 * Math.floor(t))
    }, function (n) {
        return n.getSeconds()
    }), fc.seconds = fc.second.range, fc.seconds.utc = fc.second.utc.range, fc.minute = Ht(function (n) {
        return new hc(6e4 * Math.floor(n / 6e4))
    }, function (n, t) {
        n.setTime(n.getTime() + 6e4 * Math.floor(t))
    }, function (n) {
        return n.getMinutes()
    }), fc.minutes = fc.minute.range, fc.minutes.utc = fc.minute.utc.range, fc.hour = Ht(function (n) {
        ...
        return n.getHours()
    }), fc.hours = fc.hour.range, fc.hours.utc = fc.hour.utc.range, fc.month = Ht(function (n) {
    ...
    var Bl = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6], Wl = [[fc.second, 1], [fc.second, 5], [fc.second, 15], [fc.second, 30], [fc.minute, 1], [fc.minute, 5], [fc.minute, 15], [fc.minute, 30], [fc.hour, 1], [fc.hour, 3], [fc.hour, 6], [fc.hour, 12], [fc.day, 1], [fc.day, 2], [fc.week, 1], [fc.month, 1], [fc.month, 3], [fc.year, 1]], Jl = Vl.multi([[".%L", function (n) {
    ...
    Wl.year = fc.year, fc.scale = function () {
        return Go(ta.scale.linear(), Wl, Jl)
    };
    var Kl = Wl.map(function (n) {
        return [n[0].utc, n[1]]
    }), Ql = Xl.multi([[".%L", function (n) {
    ...
    Kl.year = fc.year.utc, fc.scale.utc = function () {
        return Go(ta.scale.linear(), Kl, Ql)
    }, ta.text = Nt(function (n) {
        return n.responseText
    }), ta.json = function (n, t) {
        return Ct(n, "application/json", Qo, t)
    }, ta.html = function (n, t) {
        return Ct(n, "text/html", na, t)
    }, ta.xml = Nt(function (n) {
